...
function E(t2) {
  let { enter: a2, exit: r3, appendPosition: i2 = false, collapse: c2 = true, collapseDuration: l = 300 } = t2;
  return function(t3) {
    let { children: u2, position: d2, preventExitTransition: p2, done: m2, nodeRef: f2, isIn: g2 } = t3;
    const y2 = i2 ? a2 + "--" + d2 : a2, h2 = i2 ? r3 + "--" + d2 : r3, T2 = (0, import_react.useRef)(), E2 = (0, import_react.useRef)(0);
    function b2(e2) {
...
function O(e2) {
  const [, o2] = (0, import_react.useReducer)((e3) => e3 + 1, 0), [c2, l] = (0, import_react.useState)([]), h2 = (0, import_react.useRef)(null), T2 = (0, import_react.useRef)(/* @__PURE__ */ new Map()).current, v2 = (e3) => -1 !== c2.indexOf(e3), E2 = (0, import_react.useRef)({ toastKey: 1, displayedToast: 0, count: 0, queue: [], props: e2, containerId: null, isToastActive: v2, getToast: (e3) => T2.get(e3) }).current;
  function _2(e3) {
  ...
  function N2(e3, n2) {
    ...
    R2.iconOut = function(e4) {
      let { theme: n3, type: o3, isLoading: s3, icon: r4 } = e4, i3 = null;
      const c4 = { theme: n3, type: o3 };
      return false === r4 || (m(r4) ? i3 = r4(c4) : (0, import_react.isValidElement)(r4) ? i3 = (0, import_react.cloneElement)(r4, c4) : p(r4) || u(r4) ? i3 = r4 : s3 ? i3 = I.spinner() : ((e5) => e5 in I)(o3) && (i3 = I[o3](c4))), i3;
    }(R2), m(i2.onOpen) && (R2.onOpen = i2.onOpen), m(i2.onClose) && (R2.onClose = i2.onClose), R2.closeButton = _3.closeButton, false === i2.closeButton || y(i2.closeButton) ? R2.closeButton = i2.closeButton : true === i2.closeButton && (R2.closeButton = !y(_3.closeButton) || _3.closeButton);
    let M2 = e3;
    (0, import_react.isValidElement)(e3) && !p(e3.type) ? M2 = (0, import_react.cloneElement)(e3, { closeToast: N3, toastProps: R2, data: v3 }) : m(e3) && (M2 = e3({ closeToast: N3, toastProps: R2, data: v3 })), _3.limit && _3.limit > 0 && E2.count > _3.limit && x2 ? E2.queue.push({ toastContent: M2, toastProps: R2, staleId: r3 }) : u(s2) ? setTimeout(() => {
      P2(M2, R2, r3);
    }, s2) : P2(M2, R2, r3);
  }
...
function R(t2) {
  let { delay: n2, isRunning: o2, closeToast: s2, type: a2, hide: r3, className: i2, style: c2, controlledProgress: u2, progress: d2, rtl: p2, isIn: f2, theme: g2 } = t2;
  ...
  return import_react.default.createElement("div", { role: "progressbar", "aria-hidden": r3 ? "true" : "false", "aria-label": "notification timer", className: T2, style: y2, [u2 && d2 >= 1 ? "onTransitionEnd" : "onAnimationEnd"]: u2 && d2 < 1 ? null : () => {
    f2 && s2();
  } });
}
R.defaultProps = { type: T.DEFAULT, hide: false };
var k = (t2) => {
  const { isRunning: n2, preventExitTransition: o2, toastRef: s2, eventHandlers: a2 } = P(t2), { closeButton: r3, children: i2, autoClose: c2, onClick: u2, type: d2, hideProgressBar: p2, closeToast: f2, transition: g2, position: y2, className: h2, style: T2, bodyClassName: v2, bodyStyle: E2, progressClassName: b2, progressStyle: C2, updateId: _2, role: I2, progress: O2, rtl: L2, toastId: N2, deleteToast: k2, isIn: B2, isLoading: M2, iconOut: D2, theme: w2 } = t2, A2 = clsx_m_default("Toastify__toast", "Toastify__toast-theme--" + w2, "Toastify__toast--" + d2, { "Toastify__toast--rtl": L2 }), F2 = m(h2) ? h2({ rtl: L2, position: y2, type: d2, defaultClassName: A2 }) : clsx_m_default(A2, h2), S2 = !!O2, z2 = { closeToast: f2, type: d2, theme: w2 };
  let H2 = null;
  return false === r3 || (H2 = m(r3) ? r3(z2) : import_react.default.isValidElement(r3) ? import_react.default.cloneElement(r3, z2) : x(z2)), import_react.default.createElement(g2, { isIn: B2, done: k2, position: y2, preventExitTransition: o2, nodeRef: s2 }, import_react.default.createElement("div", { id: N2, onClick: u2, className: F2, ...a2, style: T2, ref: s2 }, import_react.default.createElement("div", { ...B2 && { role: I2 }, className: m(v2) ? v2({ type: d2 }) : clsx_m_default("Toastify__toast-body", v2), style: E2 }, null != D2 && import_react.default.createElement("div", { className: clsx_m_default("Toastify__toast-icon", { "Toastify--animate-icon Toastify__zoom-enter": !M2 }) }, D2), import_react.default.createElement("div", null, i2)), H2, (c2 || S2) && import_react.default.createElement(R, { ..._2 && !S2 ? { key: "pb-" + _2 } : {}, rtl: L2, theme: w2, delay: c2, isRunning: n2, isIn: B2, closeToast: f2, hide: p2, type: d2, style: C2, className: b2, controlledProgress: S2, progress: O2 })));
};
...
var A = (0, import_react.forwardRef)((t2, n2) => {
  const { getToastToRender: o2, containerRef: a2, isToastActive: r3 } = O(t2), { className: i2, style: c2, rtl: u2, containerId: d2 } = t2;
  function p2(e2) {
  ...
  return (0, import_react.useEffect)(() => {
    ...
    return import_react.default.createElement("div", { className: p2(t3), style: o3, key: "container-" + t3 }, n3.map((t4, o4) => {
      ...
      return import_react.default.createElement(k, { ...a3, isIn: r3(a3.toastId), style: { ...a3.style, "--nth": o4 + 1, "--len": n3.length }, key: "toast-" + a3.key }, s2);
    }));
  }));
});
...
W.loading = (e2, t2) => U(e2, Q(T.DEFAULT, { isLoading: true, autoClose: false, closeOnClick: false, closeButton: false, draggable: false, ...t2 })), W.promise = function(e2, t2, n2) {
  ...
  const i2 = { isLoading: null, autoClose: null, closeOnClick: null, closeButton: null, draggable: null, delay: 100 }, c2 = (e3, t3, s3) => {
    ...
    const a3 = { type: e3, ...i2, ...n2, data: s3 }, r4 = p(t3) ? { render: t3 } : t3;
